...
#
# Utilisation rapide:
#   from service.core.features import build_training_frame
...
# 🔧 Imports internes : d'abord relatifs (layout package core), puis fallback service.train.*
try:
    from .cal_features import add_time_features
except Exception:
    from service.train.cal_features import add_time_features  # shim de compat
