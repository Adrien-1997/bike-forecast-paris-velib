...
#
# Tolérant au layout:
#   - service/core/* (privilégié)
#   - service/train/* (shim de compat)
#   - aplati train/*  (fallback)
# =============================================================================
...
def _import_build_training_frame():
    """
    Import tolérant: core → service.train → train (aplati)
    """
    try:
    ...
    try:
        ...
        raise RuntimeError("Missing 'features.build_training_frame' (service.core/train.*).") from e
...
def _import_training_utils_for_offline():
    ...
    Ordre: core → service.train → train (aplati)
    """
    # core
    try:
    ...
    try:
        ...
        raise RuntimeError("Missing required utilities in 'features' (core/service.train/train).") from e
