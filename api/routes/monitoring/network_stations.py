...
def _local_path_from_gs(uri: str) -> Path:
    ...
    Exemple :
        gs://.../velib/monitoring/network/stations/latest/kpis.json
        → DATA_ROOT / "monitoring/network/stations/latest/kpis.json"
    """
...
def _mon_prefix_or_500() -> str:
    ...
    if not mon.startswith("gs://"):
        print(
            f"[network_stations] GCS_MONITORING_PREFIX invalide. "
